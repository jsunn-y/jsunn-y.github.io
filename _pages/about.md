...
I recently completed my PhD in chemical engineering at Caltech, coadvised by [Professor Frances Arnold](http://fhalab.caltech.edu) and [Professor Yisong Yue](http://www.yisongyue.com), where I was supported by the [NSF GRFP](https://www.nsfgrfp.org) and the [Google PhD Fellowship](https://research.google/programs-and-events/phd-fellowship/). Broadly, I am interested in developing machine learning-assisted workflows for protein engineering, particularly for discovering and optimizing enzymes.

I interned during summer 2024 at [Profluent](https://www.profluent.bio), and I was previously a co-organizer for the ML for protein engineering [seminar series](https://www.ml4proteinengineering.com). I completed my BS in chemical engineering and applied math at Yale University. During my undergrad, I worked on membranes for water treatment with [Professor Menachem Elimelech](https://elimelechlab.yale.edu), and molecular simulation and machine learning of polymers with [Professor Ying Li](https://pdelab.engr.wisc.edu). In the past, I have also interned at [Genentech](https://www.gene.com) and [NREL](https://www.nrel.gov).
